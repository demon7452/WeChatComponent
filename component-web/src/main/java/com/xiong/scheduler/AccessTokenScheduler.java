package com.xiong.scheduler;

import com.alibaba.fastjson.JSON;
import com.xiong.dtos.AccessTokenRpsDto;
...
//        }
        ...
        if((HttpStatus.OK != responseEntity.getStatusCode()) || StringUtils.isEmpty(accessTokenRpsDto.getAccess_token())){
